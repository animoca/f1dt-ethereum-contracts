...
// const {ZeroAddress, Zero, One, Two, Three} = require('@animoca/ethereum-contracts-core').constants;
// const {stringToBytes32} = require('@animoca/ethereum-contracts-sale_base/test/utils/bytes32');

// const Sale = artifacts.require('CrateKeySale');
...
//       const revert = this.sale.start({from: purchaser});
